...
*   **Vertex Shader**:
    ...
    5.  **Color Calculation**: The base color is taken from the packed data. If SHs are used, `EvalSH` is called to unpack the SH data and calculate the view-dependent color component, which is then added.
