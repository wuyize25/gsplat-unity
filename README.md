...
The `Brightness` slider option allows post-hoc scaling of the Gsplat Asset's brightness. This is functional regardless of colour space choices, but will degrade quality if the project and assets are in Gamma Space.
